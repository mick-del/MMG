...
def afficher_accueil():
    ...
    st.markdown(
        ...
        unsafe_allow_html=True)
    st.image("https://github.com/mick-del/MMG/blob/main/DJI_0736.JPG", caption="Mine de Kinsevere", use_container_width=True)
            ...
            if selected_stations:
                ...
                if quantity_of_explosives > 0:
                    ...
                    if st.button("Cliquez pour faire la prédiction"):
                        ...
                        new_ID2 = pd.DataFrame({'MLR': predictions_MLR_model_2,
...
if menu == "Accueil":
    ...
    st.markdown("<h2 style='text-align: center; color: black;'>Bienvenu(e) dans le menu de la  nouvelle prediction</h2>",
                unsafe_allow_html=True)
    st.image("https://github.com/mick-del/MMG/blob/main/G2-1~2.PNG", caption="",
             use_container_width=True)
    st.markdown(
